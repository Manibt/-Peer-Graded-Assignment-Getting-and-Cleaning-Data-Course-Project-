Peer-graded Assignment: Getting and Cleaning Data Course Project This repository is a Mani B H (mmbell) submission for Getting and Cleaning Data course project. It has the instructions on how to run analysis on Human Activity recognition dataset.
